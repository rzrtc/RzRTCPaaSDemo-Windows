...
public:
    ...
    static std::shared_ptr<RZAudioVolumeIndication>
    createAudioVolumeIndication(int interval, AudioVolumeIndicationEventHandler* event);
    ...
    static std::shared_ptr<RZLastmileProbeCalculate>
    createLastmileProbeCalculate(LastmileProbeEventHandler* eventHandler, int calculateIntervalSec = 3);

    static std::shared_ptr<DataFlow<VideoData>>
    createVideoDataFlow(const std::string& flowName, const std::shared_ptr<DataFlowMonitor>& monitor,
    ...
    static std::shared_ptr<DataFlow<AudioData>>
    createAudioDataFlow(const std::string& flowName, const std::shared_ptr<DataFlowMonitor>& monitor,
    ...
    static std::shared_ptr<AudioSolSendDataConsumer>
    createAudioSolSendDataConsumer(AudioSolSendDataConsumerEventHandler* event);

    static std::shared_ptr<VideoSolSendDataConsumer>
    createVideoSolSendDataConsumer(VideoSolSendDataConsumerEventHandler* event);
    ...
    static std::shared_ptr<AudioSourceDataProducer>
    createAudioSourceDataProducer(AudioSource* source, uint32_t frameRate, AudioSourceDataProducerEventHandler* event);

    static std::shared_ptr<AudioSourceDataProducer>
    createAudioSourceDataProducer(IAudioSource* source, uint32_t frameRate, AudioSourceDataProducerEventHandler* event);

    static std::shared_ptr<VideoSourceDataProducer>
    createVideoSourceDataProducer(VideoSource* source, uint32_t frameRate, VideoSourceDataProducerEventHandler* event);

    static std::shared_ptr<VideoSourceDataProducer>
    createVideoSourceDataProducer(IVideoSource* source, uint32_t frameRate, VideoSourceDataProducerEventHandler* event,
                                  bool isLowStream);

    static std::shared_ptr<AudioSolRecvDataProducer>
    createAudioSolRecvDataProducer(const StreamConfig& stream, AudioSolRecvDataProducerEventHandler* event);

    static std::shared_ptr<VideoSolRecvDataProducer>
    createVideoSolRecvDataProducer(const StreamConfig& stream, VideoSolRecvDataProducerEventHandler* event);
    ...
    static std::shared_ptr<IAudioDeviceCollection>
    createAudioRecordingDeviceCollection(AudioDeviceCollectionalEventHandler*);

    static std::shared_ptr<IAudioDeviceCollection>
    createAudioPlaybackDeviceCollection(AudioDeviceCollectionalEventHandler*);
    ...
    static std::shared_ptr<AudioDataOutputConsumer>
    createAudioDataOutputConsumer(const SubAudioStreamInfo& stream, AudioDataOutputConsumerEventHandler* event);

    static std::shared_ptr<AudioDataOutputConsumer>
    createAudioDataOutputConsumer(const SubAudioStreamInfo& stream, IAudioSink* sink,
                                  AudioDataOutputConsumerEventHandler* event);
    ...
    static std::shared_ptr<DataConsumerAdapter<VideoData>>
    createVideoDataConsumerAdapter(std::function<void(std::shared_ptr<VideoData>& data)> fun);

    static std::shared_ptr<DataConsumerAdapter<AudioData>>
    createAudioDataConsumerAdapter(std::function<void(std::shared_ptr<AudioData>& data)> fun);
