...
namespace rz {
    ...
    public:
        ...
        static std::shared_ptr<RZAudioVolumeIndication> createAudioVolumeIndication(int interval,AudioVolumeIndicationEventHandler *event);
        ...
        static std::shared_ptr<systemInfoCollection> createSystemInfoCollection(int interval,systemInfoCollectionEventHandler* event);
        ...
        static std::shared_ptr<RZLastmileProbeCalculate> createLastmileProbeCalculate(LastmileProbeEventHandler *eventHandler,int calculateIntervalSec = 3);

        static std::shared_ptr<DataFlow<VideoData>> createVideoDataFlow(const std::string &flowName,const std::shared_ptr<DataFlowMonitor> &monitor,const std::shared_ptr<DataProducer<VideoData>> &producer,const std::shared_ptr<DataConsumer<VideoData>> consumer);
        ...
        static std::shared_ptr<AudioEncoder> createAudioEncoder(AUDIO_CODEC_TYPE codecType,AudioCodecConfig &cfg, AudioEncoderEventHandler *eventHandler);

        static std::shared_ptr<AudioDecoder> createAudioDecoder(AUDIO_CODEC_TYPE codecType,AudioCodecConfig &cfg, AudioDecoderEventHandler *eventHandler);

        static std::shared_ptr<AudioEncoderManage> createAudioEncoderManage(AUDIO_CODEC_TYPE codecType,AudioCodecConfig &cfg, AudioEncoderManagerEventHandler *eventHandler);

        static std::shared_ptr<AudioDecoderManage> createAudioDecoderManage(AudioCodecConfig &cfg, AudioDecoderEventHandler *eventHandler);

        static std::shared_ptr<AudioHowling> createAudioHowling(AudioHowlingConfig &cfg, AudioHowlingEventHandler *errorEvent);

        static std::shared_ptr<AudioMix> createAudioMix(AudioMixConfig &cfg, AudioMixEventHandle *eventHandler);

        static std::shared_ptr<AudioResample> createAudioResample(AudioResampleConfig &cfg, AudioResampleEventHandler *errorEvent);

        static std::shared_ptr<AudioVolumeDetect> createAudioVolumeDetect(AudioVolumeDetectConfig &cfg, AudioVolumeDetectEventHandler *eventHandler);

        static std::shared_ptr<AudioSinkDataConsumer> createAudioSinkDataConsumer(AudioSink *sink);

        static std::shared_ptr<VideoSinkDataConsumer> createVideoSinkDataConsumer(VideoSink *sink,VIDEO_MIRROR_MODE_TYPE mirror,VideoSinkDataConsumerEventHandler *event);

        static std::shared_ptr<VideoSinkDataConsumer> createVideoSinkDataConsumer(IVideoSink *sink,VIDEO_MIRROR_MODE_TYPE mirror,VideoSinkDataConsumerEventHandler *event);

        static std::shared_ptr<AudioSolSendDataConsumer> createAudioSolSendDataConsumer(AudioSolSendDataConsumerEventHandler *event);

        static std::shared_ptr<VideoSolSendDataConsumer> createVideoSolSendDataConsumer(VideoSolSendDataConsumerEventHandler *event);

        static std::shared_ptr<rzrtc::RZStreamHandler> createAudioSolPubStream(rzrtc::RZStreamConfig &context, rzrtc::RZStreamHandlerEvent *event);
        ...
        static std::shared_ptr<VideoSourceDataProducer> createVideoSourceDataProducer(IVideoSource *source,uint32_t frameRate,VideoSourceDataProducerEventHandler *event);

        static std::shared_ptr<AudioSolRecvDataProducer> createAudioSolRecvDataProducer(const StreamConfig &stream,AudioSolRecvDataProducerEventHandler *event);

        static std::shared_ptr<VideoSolRecvDataProducer> createVideoSolRecvDataProducer(const StreamConfig &stream,VideoSolRecvDataProducerEventHandler *event);

        static std::shared_ptr<rzrtc::RZStreamHandler> createAudioSolSubStream(rzrtc::RZStreamConfig &context, rzrtc::RZStreamHandlerEvent *event);
        ...
        static std::shared_ptr<IAudioDeviceCollection> createAudioRecordingDeviceCollection(AudioDeviceCollectionalEventHandler *);

        static std::shared_ptr<IAudioDeviceCollection> createAudioPlaybackDeviceCollection(AudioDeviceCollectionalEventHandler *);
        ...
        static std::shared_ptr<VideoEncoder> createVideoEncoder(VIDEO_CODEC_TYPE type,VideoEncoderConfig &encodeCfg, VideoEncodeEventHandler *handler);
        ...
        static std::shared_ptr<VideoPreviewObserver> createVideoPreviewObserver(const PubVideoStreamInfo &stream,VIDEO_MIRROR_MODE_TYPE mirror, VideoPreviewObserverEventHandler *event);

        static std::shared_ptr<AudioDataOutputConsumer> createAudioDataOutputConsumer(const SubAudioStreamInfo &stream,AudioDataOutputConsumerEventHandler *event);

        static std::shared_ptr<AudioDataOutputConsumer> createAudioDataOutputConsumer(const SubAudioStreamInfo &stream,IAudioSink *sink,AudioDataOutputConsumerEventHandler *event);
        ...
        static std::shared_ptr<DataConsumerAdapter<VideoData>> createVideoDataConsumerAdapter(std::function<void(std::shared_ptr<VideoData> &data)> fun);

        static std::shared_ptr<DataConsumerAdapter<AudioData>> createAudioDataConsumerAdapter(std::function<void(std::shared_ptr<AudioData> &data)> fun);

        static std::shared_ptr<VideoEncodecManage> createVideoEncoderManage(CODEC_PRIORITY codecPriority,VideoEncoderConfig cfg,VideoEncodeManageEventHandler *event);

        static std::shared_ptr<VideoDecodecManage> createVideoDecoderManage(const std::string& streamId, CODEC_PRIORITY codecPriority,VideoDecodeManageEventHandler *event);

        static std::shared_ptr<VideoMirrorModeProcess> createVideoMirrorModeProcess(VideoMirrorModeProcessConfig &cfg,VideoMirrorModeProcessEventHandler *);

        static std::shared_ptr<PubVideoDualStream> createPubVideoDualStream(const PubVideoStreamInfo &streamInfo, PubVideoDualStreamEventHandler *event);

        static std::shared_ptr<SubVideoDualStream> createSubVideoDualStream(const SubVideoStreamInfo &streamInfo, MediaStreamSync *sync,SubVideoDualStreamEventHandler *event);
        ...
        static std::shared_ptr<PubVideoStream> createPubVideoStream(const PubVideoStreamInfo &stream,const std::shared_ptr<VideoSource> &source,PubVideoStreamEventHandler *event,std::function<void()> fun = nullptr);

        static std::shared_ptr<PubVideoStream> createPubVideoStream(const PubVideoStreamInfo &stream,IVideoSource *source,PubVideoStreamEventHandler *event, std::function<void()> fun = nullptr);

        static std::shared_ptr<SubVideoStream> createSubVideoStream(const SubVideoStreamInfo &stream,MediaStreamSync *sync,IVideoSink *sink,SubVideoStreamEventHandler *event, std::function<void()> fun = nullptr);
        ...
        static std::shared_ptr<SubAudioStream> createSubAudioStream(const SubAudioStreamInfo &stream,MediaStreamSync *sync,IAudioSink *sink,SubAudioStreamEventHandler *event, std::function<void()> fun = nullptr);

        static std::shared_ptr<AudioPlayback> createAudioPlayback(const AudioSinkConfig &cfg,AudioPlaybackEventHandler *event);
