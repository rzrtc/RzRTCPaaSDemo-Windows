...
#ifndef PAASSDK_IRTCSTREAMEVENTHANDLER_H
#define PAASSDK_IRTCSTREAMEVENTHANDLER_H
...
namespace rz{
    ...
    public:
        ...
        virtual void onLocalVideoStateChanged(IRtcStream *stream,LOCAL_VIDEO_STREAM_STATE state,
                                              LOCAL_VIDEO_STREAM_ERROR error, int elapsed) {
            (void) stream;
            (void) state;
            (void) error;
            (void) elapsed;
...
#endif //PAASSDK_IRTCSTREAMEVENTHANDLER_H
