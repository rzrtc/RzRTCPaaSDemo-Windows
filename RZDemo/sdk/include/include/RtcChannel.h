...
public:
    ...
    /**
         * 所有参数必须传递, 不能为空
         */
    IRtcStream* createVideoStream(const char* streamName, IVideoSource* videoSource, VIDEO_STREAM_TYPE streamType,
                                  IRtcStreamEventHandler* event, const VideoEncoderConfiguration& videoCfg) override;
    ...
    int setRemoteRenderMode(const char* uid, const char* streamName, RENDER_MODE_TYPE renderMode,
