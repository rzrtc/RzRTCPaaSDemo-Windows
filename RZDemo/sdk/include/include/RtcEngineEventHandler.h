...
class RtcEngineEventHandler {
    ...
    std::map<std::string, IRtcChannelEventHandler*>
        channelEventHandlerPool;  //channel相关事件回调eventHandler 包含远端音视频流事件 频道内用户上下线
...
public:
    ...
    * @param elapsed
    */
    void onClientRoleChanged(const std::string& channelName, CLIENT_ROLE_TYPE oldRole, CLIENT_ROLE_TYPE newRole,
                             int elapsed);
    ...
    */
    ...
    void onLocalVideoStateChanged(const std::string& channelName, const std::string& streamName,
                                  LOCAL_VIDEO_STREAM_STATE state, LOCAL_VIDEO_STREAM_ERROR error, int elapsed);

    void onLocalAudioStateChanged(const std::string& channelName, const std::string& streamName,
                                  LOCAL_AUDIO_STREAM_STATE state, LOCAL_AUDIO_STREAM_ERROR error, int elapsed);

    void onAudioPublishStateChanged(const std::string& channelName, const std::string& streamName,
                                    PUBLISH_STREAM_STATE state, int elapsed);

    void onVideoPublishStateChanged(const std::string& channelName, const std::string& streamName,
                                    PUBLISH_STREAM_STATE state, int elapsed);

    void onAudioSubscribeStateChanged(const std::string& channelName, const std::string& uid,
                                      const std::string& streamFlag, SUBSCRIBE_STREAM_STATE oldState, int elapsed);

    void onVideoSubscribeStateChanged(const std::string& channelName, const std::string& uid,
                                      const std::string& streamFlag, SUBSCRIBE_STREAM_STATE oldState, int elapsed);
    ...
    * @param elapsed
    */
    void onFirstLocalVideoFrame(const std::string& channelName, const std::string& streamName, int width, int height,
                                int elapsed);
    ...
    * @return
    */
    void onFirstRemoteVideoFrame(const std::string& channelName, const std::string& uid, const std::string& streamName,
    ...
    * @param rotation
    */
    void onLocalVideoSizeChanged(const std::string& channelName, const std::string& uid, const std::string& streamName,
                                 int width, int height, int elapsed);
    ...
    * @param rotation
    */
    void onRemoteVideoSizeChanged(const std::string& channelName, const std::string& uid, const std::string& streamName,
                                  int width, int height, int elapsed);
    ...
    * @param reason
    */
    void onConnectionStateChanged(const std::string& channelName, CONNECTION_STATE_TYPE state,
    ...
    * 带宽预测推荐码率回调
    */
    void onPredictedBitrateChanged(const std::string& channelName, const std::string& uid,
                                   const std::string& streamName, int newBitrate, bool isRemote, bool isLow);
