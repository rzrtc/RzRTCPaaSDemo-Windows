...
#ifndef PAASSDK_IRTCCHANNEL_H
#define PAASSDK_IRTCCHANNEL_H
...
namespace rz {
    ...
    public:
         ...
         * @return
         */
        virtual IRtcStream * createVideoStream(const char *streamName, IVideoSource *videoSource,VIDEO_STREAM_TYPE streamType,IRtcStreamEventHandler *event,const VideoEncoderConfiguration &videoCfg) = 0;
         ...
         * < 0: 方法调用失败
         */
        virtual int setRemoteRenderMode(const char *uid,const char *streamName, RENDER_MODE_TYPE renderMode,
